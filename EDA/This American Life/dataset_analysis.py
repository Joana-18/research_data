...
def create_csv(path, labels_path):
    ...
    for file in os.listdir(path):
        ...
        rows.append(["This American Life", round(duration/60, 3), num_speakers, round(percentage, 3), round(mean_snr, 3), file.split('.')[0]])
       
    
    # Source https://www.pythontutorial.net/python-basics/python-write-csv-file/
    with open("TAM_Statistics.csv", 'a', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
