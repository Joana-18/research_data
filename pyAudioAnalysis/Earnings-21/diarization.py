...
OUTPUT_PATH_BASELINE = '/research_data/pyAudioAnalysis/Earnings-21/results/baseline/'
OUTPUT_PATH_EXACT = '/research_data/pyAudioAnalysis/Earnings-21/results/exact/'
