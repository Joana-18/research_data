...
def diarization(data_path, output_path, exactNum = False, gt_path = "", 
                isFar = False, set_name = '', asr_based_ts = False):
    if asr_based_ts:
...
print('-' * 20, "BASELINE FAR".center(5), '-' * 20, flush=True)
diarization(TEST_FAR_PATH, OUTPUT_PATH_BASELINE + 'far_fixed_asr_based/', isFar = True, set_name = 'far', asr_based_ts = True)

print('-' * 20, "BASELINE NEAR".center(5), '-' * 20, flush=True)
diarization(TEST_NEAR_PATH, OUTPUT_PATH_BASELINE + 'near_fixed/', set_name = 'near')

print('-' * 20, "BASELINE NEAR".center(5), '-' * 20, flush=True)
diarization(TEST_NEAR_PATH, OUTPUT_PATH_BASELINE + 'near_fixed_asr_based/', set_name = 'near', asr_based_ts = True)
...
print('-' * 20, "EXACT FAR".center(5), '-' * 20, flush=True)
diarization(TEST_FAR_PATH, OUTPUT_PATH_EXACT + 'far_fixed_asr_based/', exactNum = True, 
            gt_path = TEST_FAR_LABELS_PATH, isFar = True, set_name = 'far', asr_based_ts = True)
...
print('-' * 20, "EXACT NEAR".center(5), '-' * 20, flush=True)
diarization(TEST_NEAR_PATH, OUTPUT_PATH_EXACT + 'near_fixed_asr_based/', exactNum = True, 
            gt_path = TEST_NEAR_LABELS_PATH, set_name = 'near', asr_based_ts = True)