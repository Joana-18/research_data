...
print('-' * 20, "BASELINE FEW".center(5), '-' * 20, flush=True)
diarization(TEST_PATH_FEW, OUTPUT_PATH_BASELINE + 'few_fixed_asr_based/', set_name ='few', asr_based_ts = True)

print('-' * 20, "BASELINE MANY".center(5), '-' * 20, flush=True)
diarization(TEST_PATH_MANY, OUTPUT_PATH_BASELINE + 'many_fixed/', set_name ='many')

print('-' * 20, "BASELINE MANY".center(5), '-' * 20, flush=True)
diarization(TEST_PATH_MANY, OUTPUT_PATH_BASELINE + 'many_fixed_asr_based/', set_name ='many', asr_based_ts = True)
...
print('-' * 20, "EXACT FEW".center(5), '-' * 20, flush=True)
diarization(TEST_PATH_FEW, OUTPUT_PATH_EXACT + 'few_fixed_asr_based/', exactNum = True, 
            gt_path = TEST_LABELS_PATH_FEW, set_name ='few', asr_based_ts = True)
...
print('-' * 20, "EXACT MANY".center(5), '-' * 20, flush=True)
diarization(TEST_PATH_MANY, OUTPUT_PATH_EXACT + 'many_fixed_asr_based/', exactNum = True, 
            gt_path = TEST_LABELS_PATH_MANY, set_name ='many', asr_based_ts = True)