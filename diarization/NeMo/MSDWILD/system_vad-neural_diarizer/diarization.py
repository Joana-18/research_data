...
import json
numpy.set_name_printoptions(threshold=sys.maxsize)
...
DOMAIN_TYPE = "telephonic" # Can be telephonic or telephonic based on domain type of the audio file
...
def diarization(data_path, output_path, exactNum = False, gt_path = "", 
    ...
    for file in os.listdir(data_path):
        try:
            ...
            if os.path.isfile(os.path.join(output_path, 'pred_rttms', file.split('.')[0] + '.rttm')):
