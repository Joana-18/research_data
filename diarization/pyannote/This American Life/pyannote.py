...
OUTPUT_PATH_EP = '/research_data/diarization/pyannote/This American Life/results/global/'
OUTPUT_PATH_BASELINE = '/research_data/diarization/pyannote/This American Life/results/baseline/'
OUTPUT_PATH_EXACT = '/research_data/diarization/pyannote/This American Life/results/exact/'
PY2_1 =  "2.1/"
PY3_1 =  "3.1/"
...
diarization(TEST_PATH, OUTPUT_PATH_EP + PY2_1 + 'test/', 3, 41, v21, globalP = True)

print('-' * 20, "GLOBAL  3.1".center(5), '-' * 20, flush=True)
diarization(TEST_PATH, OUTPUT_PATH_EP + PY3_1 + 'test/', 3, 41, v31, globalP = True)
