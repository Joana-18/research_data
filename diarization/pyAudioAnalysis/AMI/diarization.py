...
OUTPUT_PATH_BASELINE = '/research_data/diarization/pyAudioAnalysis/AMI/results/baseline/'
OUTPUT_PATH_EXACT = '/research_data/diarization/pyAudioAnalysis/AMI/results/exact/'
    ...
    for dir in os.listdir(data_path):
        ...
        for file in os.listdir(dir_path):
            ...
            if os.path.isfile(os.path.join(output_path, file.split('.')[0] + '.rttm')):
                ...
                try:
                    result = diarize(dir_path, file, exactNum, gt_path)
                    if result == None:
