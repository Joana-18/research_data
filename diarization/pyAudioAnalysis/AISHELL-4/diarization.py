...
TEST_PATH = '/path/to/datasets/folder/AISHELL-4_wav/mono/'

TEST_LABELS_PATH = os.path.join(DATASET_PATH, 'test/TextGrid')

OUTPUT_PATH_BASELINE = '/research_data/diarization/pyAudioAnalysis/AISHELL-4/results/baseline/'
OUTPUT_PATH_EXACT = '/research_data/diarization/pyAudioAnalysis/AISHELL-4/results/exact/'
...
#---------------------------- BASELINE ----------------------------
print('-' * 20, "BASELINE TEST".center(5), '-' * 20, flush=True)
diarization(TEST_PATH, OUTPUT_PATH_BASELINE + 'test/')

#---------------------------- EXACT ----------------------------
print('-' * 20, "EXACT TEST".center(5), '-' * 20, flush=True)
