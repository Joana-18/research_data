...
OUTPUT_PATH_BASELINE = '/research_data/diarization/pyAudioAnalysis/Earnings-21/results/baseline/'
OUTPUT_PATH_EXACT = '/research_data/diarization/pyAudioAnalysis/Earnings-21/results/exact/'
