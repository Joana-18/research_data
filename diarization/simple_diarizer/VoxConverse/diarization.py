...
DATASET_PATH = '/datasets/VoxConverse/'
TEST_PATH = os.path.join(DATASET_PATH, 'Data/test')

TEST_LABELS_PATH = os.path.join(DATASET_PATH, 'GroundTruth/test')
OUTPUT_PATH_BASELINE = '/research_data/diarization/simple_diarizer/VoxConverse/results/baseline/'
OUTPUT_PATH_EXACT = '/research_data/diarization/simple_diarizer/VoxConverse/results/exact/'
